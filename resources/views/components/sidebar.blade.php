<div class="flex items-center justify-between bg-indigo-900 rounded-r xl:hidden">
...
<div
    class="flex flex-col items-start justify-start w-full h-screen transition duration-500 ease-in-out transform bg-indigo-900 -screen xl:rounded-r xl:translate-x-0 sm:w-64">

    <div class="items-center justify-start hidden p-6 space-x-3 xl:flex">
        <p class="text-2xl leading-6 text-white">{{ config('app.name') }}</p>
    </div>
    <div class="flex flex-col items-center justify-start w-full pb-5 pl-4 mt-6 space-y-3 border-b border-gray-600 ">
        <div
            class="flex items-center justify-start w-full px-3 py-2 text-gray-400 rounded hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 md:w-52">
            <a>
        ...
        <button
            class="flex items-center w-full space-x-6 text-white rounded jusitfy-start focus:outline-none focus:text-indigo-400 ">
    ...
    <div class="flex flex-col items-center justify-start w-full px-6 border-b border-gray-600 ">
        <button onclick="showMenu2(true)"
            class="flex items-center justify-between w-full py-5 text-white focus:outline-none focus:text-indigo-400 space-x-14 ">
        ...
        <div class="flex flex-col items-start justify-start hidden pb-5 ">
            <button
                class="flex items-center justify-start w-full px-3 py-2 space-x-6 text-gray-400 rounded hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 md:w-52">
                <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="flex flex-col items-center justify-between w-full h-full px-6 pb-6 space-y-32 ">
        ...
        <div class="flex flex-col items-start justify-start hidden pb-5 ">
            <button
                class="flex items-center justify-start px-3 py-2 space-x-6 text-gray-400 rounded hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 w-52">
                <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path d="M15 10L11 14L17 20L21 4L3 11L7 13L9 19L12 15" stroke="currentColor" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round" />
        ...
        <div class="flex items-center justify-between w-full ">
            <div class="flex items-center justify-center space-x-2">
                ...
                <div class="flex flex-col items-start justify-start">
                    <p class="text-sm leading-5 text-white cursor-pointer">Alexis Enache</p>
                    <p class="text-xs leading-3 text-gray-300 cursor-pointer">alexis81@gmail.com</p>
                </div>
            </div>
